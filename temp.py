...
class Car:
    ...
    def draw(self, screen, respawn_counter, speed, acceleration, turning_counter):
        ...
        distance_text = font.render("Distance Travelled: {:.2f}".format(self.distance_forward), True, text_color)
        ...
        angle_text = font.render("Turning: {}".format(turning_counter), True, text_color)
    ...
    def update(self, game_map, keys):
        ...
        # kill if car is less than 15 away from the border
